<template>
    <!-- jumbotron -->
        <div class="jumbo p-5">
            <div class="container h-100 container-fluid d-flex flex-column justify-content-around">
                <h2 class="text-light ">Scelti per Martina Oggi</h2>
                <div class="w-50 testo-jumbo">
                    <div>
